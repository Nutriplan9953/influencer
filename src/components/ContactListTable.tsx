...
export const ContactListTable = ({ contacts, onEdit, onDelete, onVerify, onContact, loading }: any) => {
  return (
          ...
          <tbody>
            {contacts.length === 0 ? (
              ...
              <tr key={c.id} className="border-b hover:bg-gray-50">
                <td className="p-2"><img src={c.profilePic} alt="Profile" className="w-10 h-10 rounded-full" loading="lazy" /></td>
